...
export interface LandingTranslations {
  ...
  dashboard: {
    ...
    uploaded: string;
    analysedRisk: string;
    uploadNewContract: string;
    uploadNewContractSub: string;
    riskSummary: string;
    riskSummarySub: string;
    contractHistory: string;
    contractHistorySub: string;
    askQuestion: string;
  ...
  history: {
    ...
    emptyAllSub: string;
    emptyAllCta: string;
    emptyCompletedHeading: string;
    emptyCompletedSub: string;
    emptyProcessingHeading: string;
    emptyProcessingSub: string;
    emptyQueuedHeading: string;
    emptyQueuedSub: string;
    emptyFailedHeading: string;
    emptyFailedSub: string;
    emptyCriticalHeading: string;
    emptyCriticalSub: string;
    clearFilter: string;
    back: string;
  };
  report: {
...
export const translations: Record<Lang, LandingTranslations> = {
  en: {
    ...
    capabilities: {
      ...
      items: [
        ...
        { icon: "💰", value: "Always Free", desc: "No hidden charges, ever" },
        {
          ...
          desc: "Data protected end-to-end",
        },
        {
          icon: "📄",
          value: "PDF, JPG, PNG, WEBP",
    ...
    auth: {
      ...
      sending: "Sending...",
      privacyNote:
        "Your email is used only for login. We never share your data or send marketing emails.",
    ...
    upload: {
      ...
      subheading:
        "Upload your employment contract for risk analysis. Supported formats: JPG, PNG, WEBP, PDF. Maximum size: 15MB.",
      ...
      securityNote:
        "Your contract is encrypted and stored securely. Only you can access it.",
    ...
    dashboard: {
      ...
      emptyDesc:
        "Upload your employment contract to check for illegal clauses and hidden risks before you sign.",
      ...
      riskMedium: "MEDIUM",
      riskLow: "LOW",
      onDuty: "Let's get to work",
      welcomeMsg: "Welcome to MigrantShield",
      missionStart: "Your mission starts here. Upload your first contract.",
      allClear: "All clear.",
      contractsAnalysed: "contracts analysed successfully.",
      failedProcessing: "failed processing. Review now.",
      needAttention: "critical flags need your attention.",
      whatsNext: "What's Next",
      recentActivity: "Recent Activity",
      noActivity: "No activity yet. Upload a contract to begin monitoring.",
      analysisFailed: "Analysis failed",
      processingText: "Processing…",
      uploaded: "Uploaded",
      analysedRisk: "Analysed · Risk score",
      uploadNewContract: "Upload New Contract",
      uploadNewContractSub: "Analyse a new employment contract",
      riskSummary: "Risk Summary",
      riskSummarySub: "View all contracts by risk level",
      contractHistory: "Contract History",
      contractHistorySub: "Browse all analysed contracts",
    ...
    riskSummaryPage: {
      title: "Risk Summary",
      subtitle: "All completed contracts ranked by risk score",
      back: "Back",
      high: "High Risk",
      medium: "Medium Risk",
      low: "Low Risk",
      ...
      date: "Date",
      flags: "Flags",
      noContracts: "No contracts in this risk category.",
      clearFilter: "Clear filter",
    ...
    chatPage: {
      pickerHeading: "Choose your language",
      pickerSub: "Suggested questions will appear in your language",
      pickerFooter:
        "You can ask in any language — the assistant will reply in the same language you write in.",
      headerTitle: "Legal Assistant",
      headerSubtitle: "Ask anything about your rights",
      suggestedLabel: "Suggested questions",
      changeLangHeading: "Change language",
      cancel: "Cancel",
      inputFooter: "Press Enter to send · Shift+Enter for new line",
    },

    history: {
      title: "Contract History",
      records: "records",
      searchPlaceholder: "Search worker, employer, country…",
      filterAll: "All",
      filterCompleted: "Completed",
      filterProcessing: "Processing",
      filterQueued: "Queued",
      filterFailed: "Failed",
      filterCritical: "Critical Flags",
      ...
      showing: "Showing",
      of: "of",
      emptyAllHeading: "No contracts yet",
      emptyAllSub: "Upload your first contract to begin analysis.",
      emptyAllCta: "Upload contract",
      emptyCompletedHeading: "No completed contracts",
      emptyCompletedSub: "Contracts will appear here once analysis is done.",
      emptyProcessingHeading: "Nothing processing",
      emptyProcessingSub: "No contracts are currently being analysed.",
      emptyQueuedHeading: "Queue is empty",
      emptyQueuedSub: "No contracts are waiting to be analysed.",
      emptyFailedHeading: "No failed contracts",
      emptyFailedSub: "All contracts processed successfully.",
      emptyCriticalHeading: "No critical flags",
      emptyCriticalSub: "No contracts have critical risk flags.",
      clearFilter: "Clear filter",
      back: "Back",
    },
    report: {
      ...
      lowConfidence:
        "AI confidence is below 85%. Some findings may be incomplete. Human review recommended.",
      requestReview: "Request Human Legal Review",
      reviewSubmitted:
        "Human review requested. A legal advisor will contact you.",
      ...
      noFlagsSub:
        "This contract appears structurally safe. Always verify with a legal professional.",
  ...
  ne: {
    ...
    hero: {
      ...
      headline:
        "सुरक्षित सम्झौता, सुरक्षित भविष्य: हस्ताक्षर गर्नु अघि जाँच गर्नुहोस्",
      subheadline:
    ...
    capabilities: {
      ...
      items: [
        ...
        {
          icon: "🔒",
          value: "इन्क्रिप्टेड र निजी",
          desc: "डेटा पूर्णतः सुरक्षित",
        },
        {
          icon: "📄",
          value: "PDF, JPG, PNG, WEBP",
          desc: "समर्थित फाइल ढाँचाहरू",
        },
      ],
    },
    howItWorks: {
    ...
    auth: {
      ...
      sending: "पठाउँदै...",
      privacyNote:
        "तपाईंको इमेल केवल लगइनका लागि प्रयोग गरिन्छ। हामी कहिल्यै तपाईंको डेटा साझा गर्दैनौं।",
      ...
      signInSub:
        "सुरक्षित एक-पटक लगइन कोड प्राप्त गर्न इमेल प्रविष्ट गर्नुहोस्।",
      verificationLabel: "प्रमाणीकरण कोड",
    },
    upload: {
      heading: "सम्झौता अपलोड गर्नुहोस्",
      subheading:
        "जोखिम विश्लेषणका लागि आफ्नो रोजगार सम्झौता अपलोड गर्नुहोस्। समर्थित ढाँचाहरू: JPG, PNG, WEBP, PDF। अधिकतम आकार: १५MB।",
      tapToSelect: "सम्झौता छान्न वा फोटो खिच्न थिच्नुहोस्",
      tapSub: "क्यामेरा, ग्यालेरी, वा फाइल पिकर",
      errorType:
        "असमर्थित फाइल प्रकार। कृपया JPG, PNG, WEBP, वा PDF अपलोड गर्नुहोस्।",
      errorSize: "फाइल धेरै ठूलो छ। अधिकतम आकार १५MB हो।",
      securityNote:
        "तपाईंको सम्झौता इन्क्रिप्ट गरी सुरक्षित राखिएको छ। केवल तपाईंले मात्र पहुँच गर्न सक्नुहुन्छ।",
    ...
    dashboard: {
      ...
      emptyDesc:
        "हस्ताक्षर गर्नु अघि अवैध धाराहरू र लुकेका जोखिमहरू जाँच गर्न आफ्नो रोजगार सम्झौता अपलोड गर्नुहोस्।",
      ...
      riskLow: "न्यून",
      onDuty: "काममा लागौं",
      welcomeMsg: "MigrantShield मा स्वागत छ",
      missionStart:
        "तपाईंको अभियान यहाँबाट सुरु हुन्छ। पहिलो सम्झौता अपलोड गर्नुहोस्।",
      allClear: "सब ठीक छ।",
      contractsAnalysed: "सम्झौताहरू सफलतापूर्वक विश्लेषण गरियो।",
      failedProcessing: "प्रशोधन असफल भयो। अहिले समीक्षा गर्नुहोस्।",
      needAttention: "गम्भीर चेतावनीहरूमा ध्यान दिन आवश्यक छ।",
      whatsNext: "अब के गर्ने?",
      recentActivity: "भर्खरका गतिविधिहरू",
      noActivity:
        "अहिलेसम्म कुनै गतिविधि छैन। अनुगमन सुरु गर्न सम्झौता अपलोड गर्नुहोस्।",
      analysisFailed: "विश्लेषण असफल",
      processingText: "प्रशोधन हुँदै…",
      uploaded: "अपलोड गरियो",
      analysedRisk: "विश्लेषण · जोखिम स्कोर",
      uploadNewContract: "नयाँ सम्झौता अपलोड गर्नुहोस्",
      uploadNewContractSub: "नयाँ रोजगार सम्झौता विश्लेषण गर्नुहोस्",
      riskSummary: "जोखिम सारांश",
      riskSummarySub: "जोखिम स्तर अनुसार सम्झौताहरू हेर्नुहोस्",
      contractHistory: "सम्झौता इतिहास",
      contractHistorySub: "सबै विश्लेषण गरिएका सम्झौताहरू हेर्नुहोस्",
    ...
    riskSummaryPage: {
      title: "जोखिम सारांश",
      subtitle: "जोखिम स्कोर अनुसार क्रमबद्ध सबै पूर्ण सम्झौताहरू",
      back: "फिर्ता",
      high: "उच्च जोखिम",
      medium: "मध्यम जोखिम",
      low: "न्यून जोखिम",
      ...
      date: "मिति",
      flags: "चेतावनी",
      noContracts: "यस जोखिम श्रेणीमा कुनै सम्झौता छैन।",
      clearFilter: "फिल्टर हटाउनुहोस्",
      deleteSelected: "चयन मेटाउनुहोस्",
      critical: "गम्भीर",
      safe: "सुरक्षित",
      of: "को",
    },
    chatPage: {
      pickerHeading: "आफ्नो भाषा छान्नुहोस्",
      pickerSub: "सुझाव गरिएका प्रश्नहरू तपाईंको भाषामा देखिनेछन्",
      pickerFooter:
        "तपाईं जुनसुकै भाषामा सोध्न सक्नुहुन्छ — सहायकले तपाईंले लेखेको भाषामै जवाफ दिनेछ।",
      headerTitle: "कानूनी सहायक",
      headerSubtitle: "आफ्नो अधिकारबारे केही पनि सोध्नुहोस्",
      suggestedLabel: "सुझाव गरिएका प्रश्नहरू",
      changeLangHeading: "भाषा परिवर्तन गर्नुहोस्",
      cancel: "रद्द गर्नुहोस्",
      inputFooter: "पठाउन Enter थिच्नुहोस् · नयाँ लाइनका लागि Shift+Enter",
    },
    history: {
      title: "सम्झौता इतिहास",
      records: "रेकर्डहरू",
      searchPlaceholder: "कामदार, रोजगारदाता, देश खोज्नुहोस्…",
      filterAll: "सबै",
      filterCompleted: "पूर्ण",
      filterProcessing: "प्रशोधन",
      filterQueued: "पंक्तिबद्ध",
      filterFailed: "असफल",
      filterCritical: "गम्भीर चेतावनी",
      emptyHeading: "कुनै सम्झौता फेला परेन",
      emptyDesc: "फरक फिल्टर प्रयास गर्नुहोस् वा नयाँ सम्झौता अपलोड गर्नुहोस्।",
      notSpecified: "उल्लेख छैन",
      risk: "जोखिम",
      filteredBy: "फिल्टर गरिएको",
      deleteAllFailed: "सबै असफल मेटाउनुहोस्",
      ...
      showing: "देखाउँदै",
      of: "को",
      emptyAllHeading: "अहिलेसम्म कुनै सम्झौता छैन",
      emptyAllSub: "विश्लेषण सुरु गर्न पहिलो सम्झौता अपलोड गर्नुहोस्।",
      emptyAllCta: "सम्झौता अपलोड गर्नुहोस्",
      emptyCompletedHeading: "कुनै पूर्ण सम्झौता छैन",
      emptyCompletedSub: "विश्लेषण सकिएपछि सम्झौताहरू यहाँ देखिनेछन्।",
      emptyProcessingHeading: "केही प्रशोधन हुँदैन",
      emptyProcessingSub: "हाल कुनै सम्झौता विश्लेषण भइरहेको छैन।",
      emptyQueuedHeading: "पङ्क्ति खाली छ",
      emptyQueuedSub: "कुनै सम्झौता विश्लेषणको प्रतीक्षामा छैन।",
      emptyFailedHeading: "कुनै असफल सम्झौता छैन",
      emptyFailedSub: "सबै सम्झौताहरू सफलतापूर्वक प्रशोधित भए।",
      emptyCriticalHeading: "कुनै गम्भीर चेतावनी छैन",
      emptyCriticalSub: "कुनै सम्झौतामा गम्भीर जोखिम संकेत छैन।",
      clearFilter: "फिल्टर हटाउनुहोस्",
      back: "फिर्ता",
    },
    report: {
      ...
      lowConfidence:
        "AI विश्वास ८५% भन्दा कम छ। केही निष्कर्ष अपूर्ण हुन सक्छ। मानव समीक्षा सिफारिस गरिन्छ।",
      requestReview: "मानव कानुनी समीक्षा अनुरोध गर्नुहोस्",
      reviewSubmitted:
        "मानव समीक्षा अनुरोध गरियो। कानुनी सल्लाहकारले सम्पर्क गर्नेछन्।",
      ...
      noFlagsSub:
        "यो सम्झौता संरचनात्मक रूपमा सुरक्षित देखिन्छ। कानुनी विशेषज्ञसँग सधैं पुष्टि गर्नुहोस्।",
