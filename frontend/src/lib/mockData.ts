    ...
    flags: [
      {
        ...
        ai_confidence: 97,
        contract_clause: 'Clause 7.2 — Employee shall bear recruitment facilitation costs of RM 4,500 per month deducted over first 6 months of employment.',
      },
      {
        issue_id: 'ISS-002',
        category: 'Passport',
        ...
        ai_confidence: 99,
        contract_clause: 'Clause 4.1 — Employee travel documents shall be retained by Employer for safekeeping during contract period.',
      },
      {
        issue_id: 'ISS-003',
        category: 'Hours',
        ...
        ai_confidence: 88,
        contract_clause: 'Clause 9.3 — Employee agrees to work up to 12 hours per day including weekends as required by operational needs.',
      },
      {
        issue_id: 'ISS-004',
        category: 'Wages',
        ...
        ai_confidence: 94,
        contract_clause: 'Clause 6.1 — Monthly basic salary: RM 900 inclusive of all allowances.',
      },
      {
        issue_id: 'ISS-005',
        category: 'Leave',
        ...
        mitigation_steps: [],
        ai_confidence: 96,
        contract_clause: 'Clause 11.1 — Employee entitled to 14 days paid annual leave per calendar year.',
      },
    ],
  },
  {
