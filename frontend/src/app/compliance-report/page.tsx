    ...
    return (
      ...
      >
        <div className="max-w-2xl mx-auto w-full px-4 py-8 pb-28 print:pb-8">
          {/* ── Actions bar ── */}
          <div className="flex items-center justify-between gap-2 mb-6 flex-wrap print:hidden">
            <button
              onClick={() => setStep("language")}
              className="flex items-center gap-2 text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 text-sm transition-colors shrink-0"
            >
            ...
            <div className="flex gap-2 flex-wrap">
              <button
                onClick={handleShare}
                className="flex items-center gap-2 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-sm font-medium px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                <Share2 size={14} /> {t.share}
              </button>
              <button
                onClick={handleDownload}
                className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium px-3 py-2 rounded-lg transition-colors"
              >
