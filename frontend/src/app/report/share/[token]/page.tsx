...
> = {
  en: {
    ...
    noIssuesDesc: "This contract passed all checks.",
    analyseOwn: "Analyse your own contract",
    analyseDesc:
      "Free AI-powered risk analysis for migrant workers. Know your rights before you sign.",
    getStarted: "Get started free",
    footerNote:
      "This report was generated by MigrantShield AI and shared by the contract owner. It is for informational purposes only and does not constitute legal advice.",
    clause: "Clause",
  ...
  ne: {
    ...
    riskCaution: "सावधानी",
    riskHigh: "उच्च जोखिम",
    contractDetails: "करार विवरण",
    sharedReport: "साझा रिपोर्ट",
    noIssues: "कुनै समस्या फेला परेन",
    noIssuesDesc: "यो करारले सबै जाँच पास गर्यो।",
    analyseOwn: "आफ्नो करार विश्लेषण गर्नुहोस्",
    analyseDesc:
      "प्रवासी कामदारहरूका लागि निःशुल्क AI जोखिम विश्लेषण। हस्ताक्षर गर्नु अघि आफ्नो अधिकार जान्नुहोस्।",
    getStarted: "निःशुल्क सुरु गर्नुहोस्",
    footerNote:
      "यो रिपोर्ट MigrantShield AI द्वारा उत्पन्न गरिएको हो। यो केवल जानकारीको लागि हो र कानूनी सल्लाह होइन।",
    clause: "अनुच्छेद",
    recommendation: "सिफारिस",
    steps: "चरणहरू",
    legalRefs: "कानूनी सन्दर्भ",
  },
  hi: {
    critical: "गंभीर",
    warning: "चेतावनी",
    ...
    noIssuesDesc: "यह अनुबंध सभी जाँच में उत्तीर्ण हुआ।",
    analyseOwn: "अपना अनुबंध विश्लेषण करें",
    analyseDesc:
      "प्रवासी कामगारों के लिए निःशुल्क AI जोखिम विश्लेषण। हस्ताक्षर से पहले अपने अधिकार जानें।",
    getStarted: "निःशुल्क शुरू करें",
    footerNote:
      "यह रिपोर्ट MigrantShield AI द्वारा तैयार की गई है। यह केवल जानकारी के लिए है और कानूनी सलाह नहीं है।",
    clause: "धारा",
    recommendation: "सिफारिश",
    steps: "चरण",
    legalRefs: "कानूनी संदर्भ",
  },
  ar: {
    critical: "خطير",
    warning: "تحذير",
    ...
    sharedReport: "تقرير مشترك",
    noIssues: "لم يتم العثور على مشاكل",
    noIssuesDesc: "اجتاز هذا العقد جميع الفحوصات.",
    analyseOwn: "حلّل عقدك الخاص",
    analyseDesc:
      "تحليل مجاني للمخاطر بالذكاء الاصطناعي للعمال المهاجرين. اعرف حقوقك قبل التوقيع.",
    getStarted: "ابدأ مجاناً",
    footerNote:
      "تم إنشاء هذا التقرير بواسطة MigrantShield AI. هو لأغراض إعلامية فقط وليس مشورة قانونية.",
    clause: "البند",
    recommendation: "التوصية",
    steps: "الخطوات",
    legalRefs: "المراجع القانونية",
  },
  tl: {
    critical: "Kritikal",
    warning: "Babala",
    ...
    contractDetails: "Detalye ng Kontrata",
    sharedReport: "Ibinahaging Ulat",
    noIssues: "Walang nahanap na problema",
    noIssuesDesc: "Pumasa ang kontratang ito sa lahat ng pagsusuri.",
    analyseOwn: "Suriin ang iyong kontrata",
    analyseDesc:
      "Libreng AI risk analysis para sa mga migranteng manggagawa. Alamin ang iyong mga karapatan bago pumirma.",
    getStarted: "Magsimula nang libre",
    footerNote:
      "Ang ulat na ito ay ginawa ng MigrantShield AI. Para lamang sa impormasyon at hindi legal na payo.",
    clause: "Sugnay",
    recommendation: "Rekomendasyon",
    steps: "Mga Hakbang",
    legalRefs: "Mga Legal na Sanggunian",
  },
  bn: {
    critical: "গুরুতর",
    warning: "সতর্কতা",
    ...
    sharedReport: "শেয়ার করা রিপোর্ট",
    noIssues: "কোনো সমস্যা পাওয়া যায়নি",
    noIssuesDesc: "এই চুক্তি সমস্ত পরীক্ষায় উত্তীর্ণ হয়েছে।",
    analyseOwn: "আপনার চুক্তি বিশ্লেষণ করুন",
    analyseDesc:
      "প্রবাসী শ্রমিকদের জন্য বিনামূল্যে AI ঝুঁকি বিশ্লেষণ। স্বাক্ষর করার আগে আপনার অধিকার জানুন।",
    getStarted: "বিনামূল্যে শুরু করুন",
    footerNote:
      "এই রিপোর্টটি MigrantShield AI দ্বারা তৈরি। এটি শুধুমাত্র তথ্যের জন্য এবং আইনি পরামর্শ নয়।",
    clause: "ধারা",
    recommendation: "সুপারিশ",
    steps: "পদক্ষেপ",
    legalRefs: "আইনি তথ্যসূত্র",
  },
};
...
export default function SharedReportPage() {
  ...
  const ui = SHARE_UI[report.language] ?? SHARE_UI["en"];
  ...
  const tabs: { key: TabKey; label: string; count: number }[] = [
    { key: "all", label: ui.all, count: report.flags_count },
    { key: "critical", label: ui.critical, count: report.critical_count },
    { key: "warning", label: ui.warnings, count: report.warning_count },
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className={`rounded-2xl border p-5 ${verdictCfg.bg}`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-right">
              <p className={`text-3xl font-black ${verdictCfg.color}`}>
                {score}
              </p>
          ...
          <div className="w-full bg-slate-700/40 rounded-full h-2">
            <div
              className={`h-2 rounded-full transition-all ${verdictCfg.bar}`}
              style={{ width: `${score}%` }}
            />
          </div>
        </div>
            ...
            <div className="flex gap-1.5 mb-3 overflow-x-auto pb-1 scrollbar-hide">
              {tabs.map((t) => (
                ...
                >
                  {t.label}
                  <span
                    className={`text-[10px] px-1.5 py-0.5 rounded-full ${activeTab === t.key ? "bg-slate-600 text-slate-200" : "bg-slate-700/50 text-slate-500"}`}
                  >
                    {t.count}
                  </span>
                </button>
        ...
        {report.flags_count === 0 && (
          <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-6 text-center">
            ...
            <p className="text-slate-400 text-xs mt-1">{ui.noIssuesDesc}</p>
          </div>
        )}
        ...
        <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5 text-center">
          ...
          <p className="text-xs text-slate-400 mb-4">{ui.analyseDesc}</p>
          <a
            href="/"
          ...
          >
            <Shield className="w-4 h-4" /> {ui.getStarted}
          </a>
        </div>

        {/* FOOTER */}
        <div className="text-center pb-4">
          <p className="text-[10px] text-slate-600">{ui.footerNote}</p>
        </div>
      </div>
    </div>
  );
